...
enum AccessibilityID {
    ...
    static let newProjectName = "projects.new.name"
    static let newProjectCreate = "projects.new.create"
    static let newProjectTags = "projects.new.tags"
    static let newProjectFolder = "projects.new.folder"
    static func newProjectPackage(_ path: String) -> String { "projects.new.package.\(path)" }
    static let reviewEmpty = "learn.review.empty"
    static let reviewProgress = "learn.review.progress"
    static let reviewNext = "learn.review.next"
    ...
    static let outputSitePreview = "output.sitePreview"
